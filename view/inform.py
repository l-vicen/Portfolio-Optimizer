class Descriptions:
    ...
    PUBLIC_DASHBOARD = 'Here the user activity history is stored. This dashboard illustrates the activity of users accorting to optimizations ran \
        over time, colored by optimization type. Below there is the whole activity table with information about the specific setting of the optimization. \
        The idea for further research is to maybe one day be able to compare and rank the portfolios generated by different users.'
